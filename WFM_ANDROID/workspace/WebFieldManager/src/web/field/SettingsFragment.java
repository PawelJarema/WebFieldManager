...
public class SettingsFragment extends PreferenceFragment {
	...
	private void setupSimplePreferencesScreen() {
		...
		header.setTitle(R.string.pref_header_connection);
		getPreferenceScreen().addPreference(header);
		addPreferencesFromResource(R.xml.pref_connection);

		// Add 'data and sync' preferences, and a corresponding header.
		header = new PreferenceCategory(getActivity());
		header.setTitle(R.string.pref_header_security);
		getPreferenceScreen().addPreference(header);
		...
		bindPreferenceSummaryToValue(findPreference("connection_service"));
	}
	 ...
	 */
	private static boolean isXLargeTablet(SettingsFragment settingsFragment) {
		return (settingsFragment.getResources().getConfiguration().screenLayout & Configuration.SCREENLAYOUT_SIZE_MASK) >= Configuration.SCREENLAYOUT_SIZE_XLARGE;
	}
	 ...
	 */
	private static boolean isSimplePreferences(SettingsFragment settingsFragment) {
		return ALWAYS_SIMPLE_PREFS
				|| Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB
				|| !isXLargeTablet(settingsFragment);
	}
	...
	public void onBuildHeaders(List<Header> target) {
		if (!isSimplePreferences(this)) {
			//new PreferenceActivity().loadHeadersFromResource(R.xml.pref_headers, target);
	...
	public static class SecurityPreferenceFragment extends PreferenceFragment {
		...
		public void onCreate(Bundle savedInstanceState) {
			super.onCreate(savedInstanceState);
			addPreferencesFromResource(R.xml.pref_security);
			bindPreferenceSummaryToValue(findPreference("change_pin_button"));
		}
	}
